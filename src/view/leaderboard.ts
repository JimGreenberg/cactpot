...
export function leaderboardView(users: LeaderboardInfo[], result?: string) {
  let leaderboardText = result ? result : "Current Season";
  if (result === "all") leaderboardText = "All Time";
